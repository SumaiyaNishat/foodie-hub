...
const Banner = () => {
  ...
  return(
    ...
    <div className='container mx-auto px-6 md:px-12 xl:px-20 flex flex-col lg:flow-row items-center justify-between gap-12'>
        {/* LFET CONTENT */}
        <div className=' w-full lg:flex-1 text-center lg:text-left '>
            ...
            <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-6xl font-pacifico animate-slide-up font-extrabold leading-tight mb=4'>
                ...
                <span className='text-orange-600'>FastFood</span> &{" "}
                <br className='hidden md:block'/>
                <span className='text-yellow-500'>Resturants</span>
            </h1>
            ...
            <div className='flex flex-wrap justify-center lg:justify-start gap-4'>
                ...
                <button className='flex items-center gap-2 md:gap-3 group' onClick={() => setShowVideo((true))}>
                    <span className='w-10 h-10 md:w-12 md:h-12 bg-red-500 rounded-full flex items-center justify-center transition group-hover:bg-red-600 group-hover:scale-110 shadow-lg relative'>
                        ...
                        <span className='text-gray-600group-hover:text-red-500font-semibold text-sm md:text-base'>
                            Watch Video
                        </span>
                    </button>
                </div>
        ...
        <div className='w-full lg:flex-1 relative max-w-sm sm:max-w-md md:max-w-lg lg-max-w-none mx-auto'>
            <div className='relative mx-auto'>
                <img src={Bannerfood}alt='Banner food' className='w-full h-auto object-cover transform-rotate-180 hover:rotate-0 transition duration_500'/>
