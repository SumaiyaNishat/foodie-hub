...
const Navbar = () => {
  ...
  <div className=' hidden md:flex space-x-4 lg:space-x-8'>
    ...
    <div className='flex items-center space-x-3'>
      ...
      {/* MOBILE MENU */}
      <div className={`md:hidden absolute top-full left-0 right-0 bg-gradient-to-b from-red-500 to-orange-600 rounded-2xl shadow-xl mt-3 mx-4 transition-all duration-300 transform ${isOpen ? 'opacity-100 visible scale-100' : 'opacity-0 invisible scale-95'}`}>
        <div className='p-4 space-y-4'>
          ...
          <div className='sm-hidden'>
            ...
            <FaSearch className='text-white/80'/></div>
          </div>
          {/* button */}
